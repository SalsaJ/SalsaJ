...
public class ColorProcessor extends ImageProcessor {
    ...
    /**
     * Gets the rGBSampleModel attribute of the ColorProcessor object
     *
     * @return The rGBSampleModel value
     */
    ...
    /**
     * Gets the color attribute of the ColorProcessor object
     *
    ...
    /**
     * Sets the minAndMax attribute of the ColorProcessor object
     *
     * @param min The new minAndMax value
     * @param max The new minAndMax value
     * @param channels The new minAndMax value
     */
    ...
    /**
     * Sets the snapshotPixels attribute of the ColorProcessor object
     *
    ...
    /**
     * Gets the pixel attribute of the ColorProcessor object
     *
     * @param x Description of the Parameter
     * @param y Description of the Parameter
    ...
    /**
     * Sets the pixels attribute of the ColorProcessor object
     *
    ...
    public ByteProcessor[] getRGBProcessor() {
        ...
        return new ByteProcessor[]{rp, gp, bp};
    }
     ...
     *
     * @param R The new rGB value
     * @param G The new rGB value
     * @param B The new rGB value
     */
    ...
    public void setRGBProcessor(ByteProcessor R, ByteProcessor G, ByteProcessor B) {
        setRGB((byte[]) R.getPixels(), (byte[]) G.getPixels(), (byte[]) B.getPixels());
    }
     ...
     * brightness).
     *
     * @param H The new hSB value
     * @param S The new hSB value
     * @param B The new hSB value
     */
     ...
     *
     * @param fp The new brightness value
     */
     ...
     * @param x Description of the Parameter
     * @param y Description of the Parameter
     * @return The interpolatedRGBPixel value
     */
     ...
     * 'smoothFactor', which must be greater than zero and less than or equal
     * 1.0
     *
     * @param width2 Description of the Parameter
     * @param height2 Description of the Parameter
     * @param smoothFactor Description of the Parameter
     * @return Description of the Return Value
     */
    ...
    public void translate(double tx, double ty) {
        ...
        for (int y = roiY; y < (roiY + roiHeight); y++) {
            ...
            for (int x = roiX; x <= xMax; x++) {
                ...
                ys = y + ty;
//				if ((xs>=-0.01) && (xs<dwidth) && (ys>=-0.01) && (ys<dheight)) {
                if ((xs >= (double) roiX) && (xs < (roiX + dwidth)) && (ys >= (double) roiY) && (ys < (roiY + dheight))) {
                    if (interpolate) {
                        if (xs < 0.0) {
                            xs = 0.0;
                        }
    ...
    /**
     * Gets the histogram attribute of the ColorProcessor object
     *
     ...
     * and 1/3. Check "Weighted RGB Conversions" in <i>Edit/Options/Conversions
     * </i> to use 0.299, 0.587 and 0.114.
     *
     * @param rFactor The new weightingFactors value
     * @param gFactor The new weightingFactors value
     * @param bFactor The new weightingFactors value
     */
     ...
     *
     * @return The weightingFactors value
     */
