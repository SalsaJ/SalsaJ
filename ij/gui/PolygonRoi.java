...
public class PolygonRoi extends Roi {
	...
	public void draw(Graphics g) {
		...
		if ((xSpline != null || type == POLYLINE || type == POLYGON)
				 && state != CONSTRUCTING && clipboard == null) {
			/*
			 *  EU_HOU END
			 */
		...
		int size2 = HANDLE_SIZE / 2;
			...
			handleColor = instanceColor != null ? instanceColor : ROIColor;
	...
	Rectangle r = poly.getBounds();
		...
		if (Recorder.record && userCreated && (type == POLYLINE)) {
	...
	/**
	 *  Gets the angleAsString attribute of the PolygonRoi object
	 *
	 *@return    The angleAsString value
	 */
	...
	/**
	 *  Adds a feature to the Handle attribute of the PolygonRoi object
	 *
	 *@param  ox  The feature to be added to the Handle attribute
	 *@param  oy  The feature to be added to the Handle attribute
	 */
	...
	/**
	 *  Gets the closestPoint attribute of the PolygonRoi object
	 *
	 *@param  x       Description of the Parameter
	 *@param  y       Description of the Parameter
	 *@param  points  Description of the Parameter
	 *@return         The closestPoint value
	 */
	 ...
	 *  Description of the Method
	 *
	 *@param  evaluationPoints  Description of the Parameter
	 */
	...
	/**
	 *  Adds a feature to the Offset attribute of the PolygonRoi object
	 */
	 ...
	 *  running average.
	 *
	 *@return    The smoothedLineLength value
	 */
	...
	/**
	 *  Returns the perimeter of this ROIs after smoothing using a 3-point running
	 *  average.
	 *
	 *@return    The smoothedPerimeter value
	 */
	 ...
	 *  particle analyzer. The algorithm counts edge pixels as 1 and corner pixels
	 *  as sqrt(2). It does this by calculating the total length of the ROI
	 *  boundary and subtracting 2-sqrt(2) for each non-adjacent corner. For
	 *  example, a 1x1 pixel ROI has a boundary length of 4 and 2 non-adjacent
	 *  edges so the perimeter is 4-2*(2-sqrt(2)). A 2x2 pixel ROI has a boundary
	 *  length of 8 and 4 non-adjacent edges so the perimeter is 8-4*(2-sqrt(2)).
	 *
	 *@return    The tracedPerimeter value
	 */
	...
	/**
	 *  Returns Feret's diameter, the greatest distance between any two points
	...
	/**
	 *  Returns the angle in degrees between the first two segments of this
	 *  polyline.
	 *
	...
	/**
	 *  Returns this ROI's X-coordinates, which are relative to origin of the
	 *  bounding box.
	 *
	 *@return    The xCoordinates value
	 */
	...
	/**
	 *  Returns this ROI's Y-coordinates, which are relative to origin of the
	 *  bounding box.
	 *
	 *@return    The yCoordinates value
	 */
	...
	int[] yp2temp = new int[maxPoints * 2];
		...
		yp2 = yp2temp;
		if (IJ.debugMode) {
			IJ.log("PolygonRoi: " + maxPoints + " points");
		}
		maxPoints *= 2;
	}
