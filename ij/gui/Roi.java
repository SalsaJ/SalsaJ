...
public class Roi extends Object implements Cloneable, java.io.Serializable {
	 ...
	 */
	public final static int CONSTRUCTING = 0, MOVING = 1, RESIZING = 2, NORMAL = 3, MOVING_HANDLE = 4;// States
	/**
	 *  Description of the Field
	 */
	public final static int RECTANGLE = 0, OVAL = 1, POLYGON = 2, FREEROI = 3, TRACED_ROI = 4, LINE = 5,
			POLYLINE = 6, FREELINE = 7, ANGLE = 8, COMPOSITE = 9, POINT = 10;// Types
	/**
	 *  Description of the Field
	 */
	public final static int HANDLE_SIZE = 5;
	/**
	 *  Description of the Field
	 */
	public final static int NOT_PASTING = -1;

	final static int NO_MODS = 0, ADD_TO_ROI = 1, SUBTRACT_FROM_ROI = 2;// modification states
	...
	/**
	 *  Sets the location attribute of the Roi object
	 *
	...
	/**
	 *  Sets the image attribute of the Roi object
	 *
	...
	/**
	 *  Gets the type attribute of the Roi object
	 *
	...
	/**
	 *  Gets the state attribute of the Roi object
	 *
	...
	/**
	 *  Gets the handleSize attribute of the Roi object
	 *
	 *@return    The handleSize value
	 */
	int getHandleSize() {
	...
	/**
	 *  Adds a feature to the Point attribute of the Roi object
	 */
	void addPoint() {
		if (!(type == POINT && previousRoi.getType() == POINT)) {
			modState = NO_MODS;
	 ...
	 *@param  subtract  Description of the Parameter
	 */
	 ...
	 *
	 *@param  c  The new instanceColor value
	 */
	 ...
	 *
	 *@param  transferMode  The new pasteMode value
	 ...
	 *
	 *@return    The currentPasteMode value
	 */
