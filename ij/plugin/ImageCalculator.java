...
public class ImageCalculator implements PlugIn {
    ...
    /**
     *  Main processing method for the ImageCalculator object
     *
    ...
    public void run(String arg) {
        ...
        // Localize operators
        String[] locoperators=new String[operators.length];
        for(int i=0;i<operators.length;i++){
            locoperators[i]=bundle.getString(operators[i]);
        }
        //EU_HOU Bundle
    ...
    public void calculate(String params, ImagePlus img1, ImagePlus img2) {
        if (img1 == null || img2 == null || params == null) {
            return;
        }
        ...
        if (op == -1) {
            //EU_HOU Bundle
            IJ.error("Image Calclulator", "No valid operator");
            return;
        }
        operator = op;
     ...
     *@param  img1     Description of the Parameter
     *@param  img2     Description of the Parameter
     *@param  apiCall  Description of the Parameter
     */
     ...
     *  Description of the Method
     *
     *@param  ip1  Description of the Parameter
     *@param  ip2  Description of the Parameter
    ...
    /**
     *  Gets the blitterMode attribute of the ImageCalculator object
     *
     *@return    The blitterMode value
     */
