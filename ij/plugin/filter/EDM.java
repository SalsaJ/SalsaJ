 ...
 *  Points and Watershed commands in the Process/Binary submenu. Note: These
 *  functions do not take ROIs into account (any ROI gets deselected). setup is
 *  called with no argument for EDM, "points" for ultimate eroded points and
 *  "watershed" for watershed segmentation. Ultimate Eroded Points and Watershed
 *  are handled by the MaximumFinder plugin applied to the EDM version
 *  09-Nov-2006 Michael Schmid
 *
 *@author     Thomas
...
public class EDM implements PlugInFilter {
	 ...
	 */
	public final static int ONE = 41;
	/**
	 *  in 16-bit EDM image this value corresponds to a pixel distance of sqrt(2)
	 */
	public final static int SQRT2 = 58;// ~ 41 * sqrt(2)
	/**
	 *  in 16-bit EDM image this value corresponds to a pixel distance of sqrt(2)
	 */
	public final static int SQRT5 = 92;// ~ 41 * sqrt(5)
	...
	/**
	 *  Main processing method for the EDM object
	 *
	...
	ImageStatistics stats = imp.getStatistics();
		...
		if (invertImage) {
			ip.invert();
		}// back to black foreground (unless settings say reverse)
	}//public void run
	 ...
	 *  (EDM). Each foreground (zero) pixel in the binary image is assigned a value
	 *  equal to its distance from the nearest background (255) pixel.
	 *
	 *@param  ip  Description of the Parameter
	 */
	 ...
	 *  image. Each foreground (black) pixel in the binary image is assigned a
	 *  value equal to its distance from the nearest background (white) pixel. Uses
	 *  the two-pass EDM algorithm from the "Image Processing Handbook" by John
	 *  Russ.
	 *
	 *@param  ip  Description of the Parameter
	 *@return     Description of the Return Value
...
//EU_HOU Bundle
	...
	/**
	 *  Sets the value attribute of the EDM object
	 *
	 *@param  offset   The new value value
	 *@param  rowsize  The new value value
	 *@param  image16  The new value value
	 */
	...
	/**
	 *  Sets the edgeValue attribute of the EDM object
	 *
	 *@param  offset   The new edgeValue value
	 *@param  rowsize  The new edgeValue value
	 *@param  image16  The new edgeValue value
	 *@param  x        The new edgeValue value
	 *@param  y        The new edgeValue value
	 *@param  xmax     The new edgeValue value
	 *@param  ymax     The new edgeValue value
	 */
	 ...
	 *
	 *@param  image16  Description of the Parameter
	 *@param  image8   Description of the Parameter
	 */
