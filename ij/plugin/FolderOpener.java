...
public class FolderOpener implements PlugIn {
	...
	/**
	 *  Main processing method for the FolderOpener object
	 *
	 ...
	 *  or ".pty".
	 *
	 *@param  rawlist  Description of the Parameter
	 *@return          Description of the Return Value
	 */
...
class FolderOpenerDialog extends GenericDialog {
	...
	/**
	 *  Constructor for the FolderOpenerDialog object
	 *
	...
	/**
	 *  Sets the stackInfo attribute of the FolderOpenerDialog object
	 */
	void setStackInfo() {
	...
	/**
	 *  Gets the number attribute of the FolderOpenerDialog object
	 *
