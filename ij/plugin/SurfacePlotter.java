...
public class SurfacePlotter implements PlugIn {
	...
	/**
	 *  Main processing method for the SurfacePlotter object
	 *
	 ...
	 *@param  offsetXDirection  Description of the Parameter
	 *@param  offsetYDirection  Description of the Parameter
	 *@param  labelSide         Description of the Parameter
	 */
	 ...
	 *  Description of the Method
	 *
	 *@param  ipProfile  Description of the Parameter
	 *@param  profile    Description of the Parameter
	 *@param  width      Description of the Parameter
	 *@param  yinc2      Description of the Parameter
	 */
	 ...
	 *@param  maxTrim  Description of the Parameter
	 *@return          Description of the Return Value
	 */
