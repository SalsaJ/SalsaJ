...
public class WindowManager {
	...
	/**
	 *  Constructor for the WindowManager object
	 */
	 ...
	 *
	 *@param  win  The new currentWindow value
	 */
	 ...
	 *
	 *@return    The currentWindow value
	 */
	...
	/**
	 *  Gets the currentIndex attribute of the WindowManager class
	 *
	...
	/**
	 *  Returns a list of the IDs of open images. Returns null if no windows are
	 *  open.
	 *
	 ...
	 *
	 *@return    The nonImageWindows value
	 */
	 ...
	 *  Returns null if no open window has a matching ID or no images are open. For
	 *  IDs greater than zero, returns the Nth ImagePlus. Returns null if the ID is
	 *  zero.
	 *
	 *@param  imageID  Description of the Parameter
	 ...
	 *
	 *@param  win  The feature to be added to the Window attribute
	 */
	...
	/**
	 *  Adds a feature to the ImageWindow attribute of the WindowManager class
	 *
	 *@param  win  The feature to be added to the ImageWindow attribute
	 */
	...
	/**
	 *  Gets the duplicateName attribute of the WindowManager class
	 *
	 *@param  name  Description of the Parameter
	 *@return       The duplicateName value
	 */
	...
	/**
	 *  Closes all windows. Stops and returns false if any image "save changes"
	 *  dialog is canceled.
	 *
	 *@return    Description of the Return Value
	 */
	...
	/**
	 *  Makes the specified image temporarily the active image. Allows use of
	 *  IJ.run() commands on images that are not displayed in a window. Call again
	 *  with a null argument to revert to the previous active image.
	 *
	 *@param  imp  The new tempCurrentImage value
	 */
	 ...
	 *
	 *@return    The tempCurrentImage value
	 */
	 ...
	 */
	/**
	 *  Gets the imageWindows attribute of the WindowManager class
	 *
	 *@return    The imageWindows value
	 */
	 ...
	 *
	 *@param  menuItemLabel  Description of the Parameter
