 ...
 *  basic matrix arithmetic, including matrix addition and multiplication,
 *  matrix norms, and element-by-element array operations. Methods for reading
 *  and printing matrices are also included. All the operations in this version
 *  of the Matrix Class involve real matrices. Complex matrices may be handled
 *  in a future version. <P>
 *
 *  Five fundamental matrix decompositions, which consist of pairs or triples of
 *  matrices, permutation vectors, and the like, produce results in five
 *  decomposition classes. These decompositions are accessed by the Matrix class
 *  to compute solutions of simultaneous linear equations, determinants,
 *  inverses and other matrix functions. The five decompositions are: <P>
 *
 *
 *  <UL>
...
public class Matrix implements Cloneable, java.io.Serializable {
	 ...
	 *
	 * @param  r   Array of row indices.
	 * @param  j0  Description of the Parameter
	 * @param  j1  Description of the Parameter
	 * @return     A(r(:),j0:j1)
	 */
