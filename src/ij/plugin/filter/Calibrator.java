...
public class Calibrator implements PlugInFilter, Measurements, ActionListener {
	...
	private final static String INVERTER = "Pixel Inverter";
	private final static String UNCALIBRATED_OD = "Uncalibrated OD";
	...
	/**
	 *  Main processing method for the Calibrator object
	 *
	 ...
	 *@param  rSquared  Description of the Parameter
	 */
	...
	/**
	 *  Gets the functionList attribute of the Calibrator object
	 *
	 *@param  custom  Description of the Parameter
	 *@return         The functionList value
	 */
	...
	/**
	 *  Gets the means attribute of the Calibrator object
	 *
	 *@return    The means value
	 */
	String getMeans() {
	...
	/**
	 *  Gets the data attribute of the Calibrator object
	 *
	...
	/**
	 *  Gets the num attribute of the Calibrator object
	 *
