 ...
 *  display for ImageJ plugins. <p>
 *
 *  <p>
 *
 *  Tne next section describes the basic scheme for rendering 3D scenes.<br />
 *  After initializing a new 3D scene, objects are added, drawing parameters and
 *  global render parameters have to be set.<br />
 *  At the end a rendering is performed that is writen to an image, which can be
 *  displayed with ImageJ. </p> <p>
 *
 *  <i>Example:</i> </p> <p>
 *
 ...
 *  rendered image</tt> </p> <p>
 *
 *  Set or add one or more 3D objects like points or spheres:<br />
 *  <tt>jRenderer3D.addPoint3D(250, 250, 20, 20, Color.WHITE);</tt> </p> <p>
 *
 ...
 *  <tt>jRenderer3D.setSurfacePlot(imp);</tt> </p> <p>
 *
 *  Or set a volume (a 3D-stack) <br />
 *  <tt>jRenderer3D.setVolume(imagePlus); // set the volume</tt> </p> <p>
 *
 ...
 *
 *  Render the image <br />
 *  <tt>jRenderer3D.doRendering();</tt> </p> <p>
 *
 *  Get the rendered new image<br />
 *  <tt>Image image = jRenderer3D.getImage();</tt> </p> <p>
 *
 *  And display it<br />
 *  <tt>ImagePlus impNew = new ImagePlus(&quot;Rendered Image&quot;, image);<br
 *  />
 *  impNew.show();<br />
 *  impNew.updateAndDraw();</tt> </p> <p/>
 *
 *  <p>
 *
 ...
 *    <p>
 *
 *    Surface plots can be generate from all image types. Selections, which can
 *    be non-rectangular, are supported.</p> <p>
 *
 *    The luminance of an image is interpreted as height for the plot.
 *    Internally the image is scaled to a 256x256 image using nearest neighbor
 *    sampling. Other dimensions for this image can be set by the
 *    setSurfacePlotGridSize method. </p> <p>
 *
 ...
 *    differences. </p> </li>
 *    <li> <strong>Volume</strong> <p>
 *
 *    Stacks can be shown as volumes or slices. 8, 16 and 32 bit stacks are
 *    supported. RGB-stacks are not supported for the moment.</p> <p>
 *
 *    The display mode of a volume may be set with the setVolumeDrawMode method
 ...
 *      interpolation is performed.</li>
 *      <li> VOLUME_PROJECTION_TRILINEAR_BACK: A 3D volume is rendered. The
 *      opacity of the voxels is controlled by the setVolumeThreshold method.
 ...
 *    using the setTransformZAspectRatio. </p> <p>
 *
 ...
 *  setTransformScale method. JRederer3D assumes the following coordinate
 *  system:</p> <p>
 *
 *  <img src="img/xyz.gif"/></p> <p>
 *
...
public class JRenderer3D {
	...
	/**
	 *  Draws a surface plot using only dots, no illumination is used (fastest
	 *  mode).
	 */
	public final static int SURFACEPLOT_DOTSNOLIGHT = 10;
	/**
	 *  Draws a surface plot using only dots, illumination is active.
	 */
	public final static int SURFACEPLOT_DOTS = 11;
	 ...
	 */
	public final static int VOLUME_DOTS = 20;

	/**
	 *  Draws a volume using nearest neighbor interpolation.
	 */
	public final static int VOLUME_SLICE_NEAREST_NEIGHBOR = 21;

	/**
	 *  Draws a volume using trilinear interpolation.
	 */
	public final static int VOLUME_SLICE_TRILINEAR = 22;
...
//	public final static int VOLUME_SLICE_AND_VOLUME_DOTS = 24;
	 ...
	 */
	public final static int VOLUME_PROJECTION_TRILINEAR_FRONT = 25;
...
//	public static final int VOLUME_PROJECTION_TRILINEAR_BACK = 26;
	 ...
	 */
	public final static int LUT_GRADIENT = 58;
	/**
	 *  Description of the Field
	 */
	public final static int LUT_GRADIENT2 = 59;


	/**
	 *  Creates a new JRenderer3D object. This has always to be the first step to
	 *  generate a 3D scene. The center is assumed at (0,0,0)
	 */
	public JRenderer3D() { }
		...
		for (int i = 0; i < lines3D.size(); i++) {
			...
			double z1 = transform.Z + 2;
				...
				int color2 = line2.color;
					...
					transform.transform(p0);
				double x0_2 = transform.X;
				double y0_2 = transform.Y;
				double z0_2 = transform.Z + 2;

					transform.transform(p1);
				double x1_2 = transform.X;
				double y1_2 = transform.Y;
				double z1_2 = transform.Z + 2;
	...
	/**
	 *  Sets the points attribute of the JRenderer3D object
	 *
	 *@param  l0  The new points value
	 *@param  p0  The new points value
	 *@param  p1  The new points value
	 */
...
//							System.out.println("--> " + ti.text);
		...
		g2D.setColor(new Color(80, 45, 164));
...
//		java.util.Arrays.fill(zbufferPixels, 1000000);
	...
	/**
	 *  Sets the linePoints attribute of the JRenderer3D object
	 *
	 *@param  lineItem  The new linePoints value
	 *@param  p1        The new linePoints value
	 *@param  p2        The new linePoints value
	 *@param  color     The new linePoints value
	...
	/**
	 *  Adds a feature to the CubeLinesList attribute of the JRenderer3D object
	 *
	 *@param  lines3D  The feature to be added to the CubeLinesList attribute
	 */
	...
	/**
	 *  This methods does the rendering and creates the 3D output. It has to be
	 *  redone after all setting changes (scale, angle, surface modes, lightning
	 *  modes, color modes etc.) Draws all given input data (lines, text, points,
	 *  cubes, surfaces).
	 */
	 ...
	 *  S E T T E R *
	 *
	 *@param  points3D  The feature to be added to the Points3D attribute
	 */
	...
	/**
	 *  Sets the surfacePlotTexture attribute of the JRenderer3D object
	 *
	 *@param  impTexture  The new surfacePlotTexture value
	 */
	...
	/**
	 *  Sets the surfacePlot attribute of the JRenderer3D object
	 *
	 *@param  imp         The new surfacePlot value
	 *@param  impTexture  The new surfacePlot value
	 */
	...
	/**
	 *  Sets the surface plot mode. <p>
	 *
	 *  Available options:
	 *  <ul>
	 *    <li> <strong>PLOT_DOTSNOLIGHT</strong> : if used, no lightning options
	 *    are applied (fastest)</li>
	 ...
	 *    <li> <strong>PLOT_FILLED</strong> : fills the 3d object completely
	 *    (slowest)</li>
	 *  </ul>
	 *
	 *
	...
	/**
	 *  Sets the mode for drawing volumes. <p>
	 *
	 *
	 *  <ul>
	...
	/**
	 *  Sets the volumeLut attribute of the JRenderer3D object
	 *
	 *@param  volume_lutNr  The new volumeLut value
	 */
	...
	/**
	 *  Sets the surface grid size (sampling rate). Should be set to an integer
	 *  fraction of the image of which the surface plot has to be generated.
	 *
...
//	general transform parameters
	 ...
	 *
	 *@param  zOrientation  <br>
	 *      -1: left hand coordinate system <br>
	...
	/**
	 *  Changes the rotation of x-, y-, and z-axis by the values of changeX and
	 *  changeY.
	 *
	 *@param  changeX  change of rotation angle of x-axis in degree
...
//		this.lines3D.addAll(Arrays.asList(lines3D));
	 ...
	 *
	 *@param  text    The feature to be added to the Text3D attribute
	 *@param  x       The feature to be added to the Text3D attribute
	 *@param  y       The feature to be added to the Text3D attribute
	 *@param  z       The feature to be added to the Text3D attribute
	 *@param  rgb     The feature to be added to the Text3D attribute
	 *@param  size    The feature to be added to the Text3D attribute
	 */
	...
	/**
	 *  Adds a feature to the TextPair3D attribute of the JRenderer3D object
	 *
	 *@param  text1_3D  The feature to be added to the TextPair3D attribute
	 *@param  text2_3D  The feature to be added to the TextPair3D attribute
	 */
	...
	/**
	 *  Sets the color lut for the surface plot. <p>
	 *
	 *
	 *  <ul>
	...
	/**
	 *  Sets the lightning for the surface plot illumination . <p>
	 *
	 *
	 *  <ul>
	 *    <li> 0: no light</li>
	...
	/**
	 *  Sets the surfacePlotMinMax attribute of the JRenderer3D object
	 *
	 *@param  surfacePlot_min  The new surfacePlotMinMax value
	 *@param  surfacePlot_max  The new surfacePlotMinMax value
	 */
	...
	/**
	 *  Sets the threshold. All voxels below this threshold are displayed
	 *  transparent.
	 *
	...
	/**
	 *  Sets the z-aspect ratio (the relative z-height of a voxel). When setting a
	 *  volume, the z-aspect ratio is reset to ratio read from the stack. If the
	 *  z-aspect ratio needs to set this has to be done after calling the setVolume
	 *  method.
	 *
	 *@param  zAspectRatio  z-aspect ratio (the relative z-ratio of a voxel) to be
	 *      set.
	 */
	...
	/**
	 *  Gets the numPoints3D attribute of the JRenderer3D object
	 *
	 *@return    The numPoints3D value
	 */
	...
	/**
	 *  Sets the transformPerspective attribute of the JRenderer3D object
	 *
	 *@param  perspective  The new transformPerspective value
	 */
	...
	/**
	 *  Sets the transformMaxDistance attribute of the JRenderer3D object
	 *
	 *@param  maxDistance  The new transformMaxDistance value
	 */
	...
	/**
	 *  Sets the axes attribute of the JRenderer3D object
	 *
	 *@param  axes  The new axes value
	 */
	...
	/**
	 *  Sets the lines attribute of the JRenderer3D object
	 *
	 *@param  lines  The new lines value
	 */
	...
	/**
	 *  Sets the text attribute of the JRenderer3D object
	 *
	...
	/**
	 *  Sets the inverse attribute of the JRenderer3D object
	 *
	 *@param  b  The new inverse value
	 */
	...
	/**
	 *  Gets the transformScale attribute of the JRenderer3D object
	 *
	 *@return    The transformScale value
	 */
