...
public class FileInfo {
	...
	public static final int GRAY16_UNSIGNED = 2;
        ...
        /** By Oli 16-bit integer (0-65535). */
	public static final int GRAY16_SIGNEDBAD = 111;
        /* end by Oli */
	...
	public int getBytesPerPixel() {
		switch (fileType) {
			...
			case GRAY16_SIGNED: case GRAY16_UNSIGNED: case GRAY16_SIGNEDBAD: return 2;
    ...
    private String getType() {
    	switch (fileType) {
			...
			case GRAY16_SIGNED: return "short";
                        case GRAY16_SIGNEDBAD: return "short";
