 ...
 *  ImageProcessor class from "KickAss Java Programming" by Tonny Espeset.
 *
 *@author     Thomas
...
public class ByteProcessor extends ImageProcessor {
	...
	final static int ERODE = 10, DILATE = 11;
	/**
	...
	/**
	 *  Sets the snapshotPixels attribute of the ByteProcessor object
	 *
	...
	/**
	 *  Gets the snapshotPixels attribute of the ByteProcessor object
	 *
	 ...
	 *  mask is not the same size as the ROI.
	 *
	 *@param  mask  Description of the Parameter
	 */
	...
	/**
	 *  Gets the pixel attribute of the ByteProcessor object
	 *
	...
	/**
	 *  Gets the pixelValue attribute of the ByteProcessor object
	 *
	 *@param  x  Description of the Parameter
	 *@param  y  Description of the Parameter
	 ...
	 *  the image boundary. Values outside the range 0-255 are clipped.
	 *
	 *@param  x      Description of the Parameter
	 *@param  y      Description of the Parameter
	 *@param  value  Description of the Parameter
	 ...
	 *  image boundary. Values outside the range 0-255 are clipped.
	 *
	 *@param  x      Description of the Parameter
	 *@param  y      Description of the Parameter
	 *@param  value  Description of the Parameter
	...
	/**
	 *  Sets the pixels attribute of the ByteProcessor object
	 *
	...
	/**
	 *  Filters using a 3x3 neighborhood. The p1, p2, etc variables, which contain
	...
	int binaryForeground = 255 - binaryBackground;
				...
				switch (type) {
								...
								case ERODE:
									if (p5 == binaryBackground) {
										...
										count = 0;
										if (p1 == binaryBackground) {
											count++;
										}
										if (p2 == binaryBackground) {
											count++;
										}
										if (p3 == binaryBackground) {
											count++;
										}
										if (p4 == binaryBackground) {
											count++;
										}
										if (p6 == binaryBackground) {
											count++;
										}
										if (p7 == binaryBackground) {
											count++;
										}
										if (p8 == binaryBackground) {
											count++;
										}
										if (p9 == binaryBackground) {
											count++;
										}
		...
		if (yMin == 1) {
			filterEdge(type, pixels2, roiWidth, roiX, roiY, 1, 0);
		}
		if (xMax == width - 2) {
			filterEdge(type, pixels2, roiHeight, width - 1, roiY, 0, 1);
		}
		if (yMax == height - 2) {
			filterEdge(type, pixels2, roiWidth, roiX, height - 1, 1, 0);
		}
		showProgress(1.0);
	}
	 ...
	 *
	 *@param  type     Description of the Parameter
	 *@param  pixels2  Description of the Parameter
	 *@param  n        Description of the Parameter
	 *@param  x        Description of the Parameter
	 *@param  y        Description of the Parameter
	 *@param  xinc     Description of the Parameter
	 *@param  yinc     Description of the Parameter
	 */
	...
	int bg = binaryBackground;
		...
		for (int i = 0; i < n; i++) {
			if (type == ERODE || type == DILATE) {
				p1 = getEdgePixel0(pixels2, bg, x - 1, y - 1);
				p2 = getEdgePixel0(pixels2, bg, x, y - 1);
				p3 = getEdgePixel0(pixels2, bg, x + 1, y - 1);
				p4 = getEdgePixel0(pixels2, bg, x - 1, y);
				p5 = getEdgePixel0(pixels2, bg, x, y);
				p6 = getEdgePixel0(pixels2, bg, x + 1, y);
				p7 = getEdgePixel0(pixels2, bg, x - 1, y + 1);
				p8 = getEdgePixel0(pixels2, bg, x, y + 1);
				p9 = getEdgePixel0(pixels2, bg, x + 1, y + 1);
			} else {
				p1 = getEdgePixel(pixels2, x - 1, y - 1);
				p2 = getEdgePixel(pixels2, x, y - 1);
				p3 = getEdgePixel(pixels2, x + 1, y - 1);
				p4 = getEdgePixel(pixels2, x - 1, y);
				p5 = getEdgePixel(pixels2, x, y);
				p6 = getEdgePixel(pixels2, x + 1, y);
				p7 = getEdgePixel(pixels2, x - 1, y + 1);
				p8 = getEdgePixel(pixels2, x, y + 1);
				p9 = getEdgePixel(pixels2, x + 1, y + 1);
			}
			switch (type) {
							case BLUR_MORE:
								sum = (p1 + p2 + p3 + p4 + p5 + p6 + p7 + p8 + p9) / 9;
	...
	/**
	 *  Gets the edgePixel attribute of the ByteProcessor object
	 *
	 *@param  pixels2  Description of the Parameter
	 *@param  x        Description of the Parameter
	 *@param  y        Description of the Parameter
	 *@return          The edgePixel value
	 */
	...
	/**
	 *  Gets the edgePixel0 attribute of the ByteProcessor object
	 *
	 *@param  pixels2     Description of the Parameter
	 *@param  background  Description of the Parameter
	 *@param  x           Description of the Parameter
	 *@param  y           Description of the Parameter
	 *@return             The edgePixel0 value
	 */
	...
	/**
	 *  Creates a new ByteProcessor containing a scaled copy of this image or
	 *  selection.
	 *
...
//				if ((xs>=-0.01) && (xs<dwidth) && (ys>=-0.01) && (ys<dheight)) {
	...
	/**
	 *  Gets the histogram attribute of the ByteProcessor object
	 *
	...
	/**
	 *  Sets the fromFloatProcessors attribute of the ByteProcessor object
	 *
	 *@param  fp  The new fromFloatProcessors value
	 */
	...
	/**
	 *  Sets the fromFloatArrays attribute of the ByteProcessor object
	 *
	 *@param  arrays  The new fromFloatArrays value
	 */
	 ...
	 *  (pixel values 0 to 255). The roi, mask, lut (ColorModel), threshold,
