...
public class Analyzer implements PlugInFilter, Measurements {
	...
	private final static int[] list = {AREA, MEAN, STD_DEV, MODE, MIN_MAX,
	...
	private final static int UNDEFINED = 0, AREAS = 1, LENGTHS = 2, ANGLES = 3, POINTS = 4;
	private static int mode = AREAS;
	private final static String MEASUREMENTS = "measurements";
	private final static String MARK_WIDTH = "mark.width";
	...
	/**
	 *  Construct a new Analyzer using an ImagePlus object and private measurement
	 *  options and results table.
	 *
	 *@param  imp           Description of the Parameter
...
//EU_HOU Bundle
		...
		states[17] = (systemMeasurements & SLICE) != 0;
		gd.setInsets(0, 0, 0);
	...
	/**
	 *  Sets the options attribute of the Analyzer object
	 *
	 *@param  gd  The new options value
	 */
	 ...
	 *
	 *@return    The redirectImage value
	 */
	 ...
	 *  was not found or the image is not the same size as <code>currentImage</code>
	 *  .
	 *
	 *@param  currentImage  Description of the Parameter
	 *@return               The redirectImage value
	 */
	...
	/**
	 *  Gets the redirectStats attribute of the Analyzer object
	 *
	 *@param  measurements  Description of the Parameter
	 *@param  roi           Description of the Parameter
	 *@return               The redirectStats value
	 */
	...
	int counter = rt.getCounter();
		...
		if ((measurements & SLICE) != 0) {
			rt.addValue(ResultsTable.SLICE, imp != null ? imp.getCurrentSlice() : 1.0);
		}
	}


	/**
	 *  Gets the fileName attribute of the Analyzer object
	 *
	 ...
	 *  headings and the displayed headings are the same. Redisplays the results if
	 *  the headings are different and the results table is not empty.
	 */
	...
	boolean macro = (IJ.macroRunning() && !switchingModes) || Interpreter.isBatchMode();
		...
		YesNoCancelDialog d = new YesNoCancelDialog(ij, "SalsaJ", "Save " + counter + " measurements?");
	...
	/**
	 *  Sets the unsavedMeasurements attribute of the Analyzer class
	 *
	 *@param  b  The new unsavedMeasurements value
	 */
	...
	/**
	 *  Gets the measurements attribute of the Analyzer class
	 *
	...
	/**
	 *  Sets the measurements attribute of the Analyzer class
	 *
	 *@param  measurements  The new measurements value
	 */
	...
	/**
	 *  Returns the ImageJ results table. This table should only be displayed in a
	 *  the "Results" window.
	 *
	 *@return    The resultsTable value
	 */
	 ...
	 *
	 *@param  decimalPlaces  The new precision value
	 */
	...
	/**
	 *  Returns an updated Y coordinate based on the current "Invert Y Coordinates"
	 *  flag.
	 *
	 *@param  y            Description of the Parameter
	 *@param  imageHeight  Description of the Parameter
	 *@return              Description of the Return Value
	 */
