...
public class Distribution implements PlugIn, TextListener {
	...
	/**
	 *  Main processing method for the Distribution object
	 *
...
//		ImageStatistics stats = new StackStatistics(imp, nBins, 0, 0);
	...
	/**
	 *  Gets the index attribute of the Distribution object
	 *
	 ...
	 *  Description of the Method
	 *
	 *@param  nc    Description of the Parameter
	 *@param  data  Description of the Parameter
	 *@param  pars  Description of the Parameter
	 */
