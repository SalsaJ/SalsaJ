...
/**
 *  This plugin decodes DICOM files. If 'arg' is empty, it displays a file open
 *  dialog and opens and displays the image selected by the user. If 'arg' is a
 *  path, it opens the specified image and the calling routine can display it
 *  using "((ImagePlus)IJ.runPlugIn("ij.plugin.DICOM", path)).show()".
 *
 *@author     Thomas
...
public class DICOM extends ImagePlus implements PlugIn {
	...
	/**
	 *  Constructs a DICOM reader that using an InputStream. Here is an example
	 *  that shows how to open and display a DICOM: <pre>
	 ...
	 *
	 *@param  bis  Description of the Parameter
	 */
	...
	/**
	 *  Main processing method for the DICOM object
	 *
	...
	/**
	 *  Opens the specified file as a DICOM. Does not display a message if there is
	 *  an error. Here is an example: <pre>
	 *DICOM dcm = new DICOM();
	 *dcm.open(path);
	 *if (dcm.getWidth()==0)
...
class DicomDecoder {
	...
	private final static int PIXEL_REPRESENTATION = 0x00280103;
	private final static int TRANSFER_SYNTAX_UID = 0x00020010;
	private final static int SLICE_SPACING = 0x00180088;
	private final static int SAMPLES_PER_PIXEL = 0x00280002;
	private final static int PHOTOMETRIC_INTERPRETATION = 0x00280004;
	private final static int PLANAR_CONFIGURATION = 0x00280006;
	private final static int NUMBER_OF_FRAMES = 0x00280008;
	private final static int ROWS = 0x00280010;
	private final static int COLUMNS = 0x00280011;
	private final static int PIXEL_SPACING = 0x00280030;
	private final static int BITS_ALLOCATED = 0x00280100;
	private final static int WINDOW_CENTER = 0x00281050;
	private final static int WINDOW_WIDTH = 0x00281051;
	private final static int RESCALE_INTERCEPT = 0x00281052;
	private final static int RESCALE_SLOPE = 0x00281053;
	private final static int RED_PALETTE = 0x00281201;
	private final static int GREEN_PALETTE = 0x00281202;
	private final static int BLUE_PALETTE = 0x00281203;
	private final static int ICON_IMAGE_SEQUENCE = 0x00880200;
	private final static int ITEM = 0xFFFEE000;
	private final static int ITEM_DELIMINATION = 0xFFFEE00D;
	private final static int SEQUENCE_DELIMINATION = 0xFFFEE0DD;
	private final static int PIXEL_DATA = 0x7FE00010;

	private final static int AE = 0x4145, AS = 0x4153, AT = 0x4154, CS = 0x4353, DA = 0x4441, DS = 0x4453, DT = 0x4454,
	...
	private final static int ID_OFFSET = 128;//location of "DICM"
	private final static String DICM = "DICM";
	...
	private final static int IMPLICIT_VR = 0x2D2D;// '--'
	...
	/**
	 *  Constructor for the DicomDecoder object
	 *
	...
	/**
	 *  Gets the string attribute of the DicomDecoder object
	 *
	...
	/**
	 *  Gets the byte attribute of the DicomDecoder object
	 *
	...
	/**
	 *  Gets the short attribute of the DicomDecoder object
	 *
	...
	/**
	 *  Gets the int attribute of the DicomDecoder object
	 *
	...
	/**
	 *  Gets the lut attribute of the DicomDecoder object
	 *
	 *@param  length           Description of the Parameter
	...
	/**
	 *  Gets the length attribute of the DicomDecoder object
	 *
	...
	/**
	 *  Gets the nextTag attribute of the DicomDecoder object
	 *
	 *@return                  The nextTag value
	 *@exception  IOException  Description of the Exception
	 */
	...
	/**
	 *  Gets the fileInfo attribute of the DicomDecoder object
	 *
	...
	String photoInterpretation = "";
		...
		if (!getString(4).equals(DICM)) {
			...
			if (IJ.debugMode) {
				//EU_HOU Bundle
				IJ.log(DICM + " not found at offset " + ID_OFFSET + "; reseting to offset 0");
			}
		} else {
			dicmFound = true;
			if (IJ.debugMode) {
				//EU_HOU Bundle
				IJ.log(DICM + " found at offset " + ID_OFFSET);
			}
		}
	...
	/**
	 *  Gets the dicomInfo attribute of the DicomDecoder object
	 *
	 *@return    The dicomInfo value
	 */
	String getDicomInfo() {
	...
	/**
	 *  Adds a feature to the Info attribute of the DicomDecoder object
	 *
	 *@param  tag              The feature to be added to the Info attribute
	 *@param  value            The feature to be added to the Info attribute
	 *@exception  IOException  Description of the Exception
	 */
	...
	/**
	 *  Gets the headerInfo attribute of the DicomDecoder object
	 *
	...
	/**
	 *  Gets the spatialScale attribute of the DicomDecoder object
	 *
	 *@param  fi     Description of the Parameter
...
class DicomDictionary {
	...
	/**
	 *  Gets the dictionary attribute of the DicomDictionary object
	 *
