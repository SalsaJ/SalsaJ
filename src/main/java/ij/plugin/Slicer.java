...
/**
 *  Implements the Image/Stacks/Reslice command. Known shortcomings: for
 *  FREELINE or POLYLINE ROI, spatial calibration is ignored: the image is
 *  sampled at constant _pixel_ increments (distance 1), so (if y/x aspect ratio
 *  != 1 in source image) one dimension in the output is not homogeneous (i.e.
 *  pixelWidth not the same everywhere).
 *
 *@author     Thomas
...
public class Slicer implements PlugIn, TextListener, ItemListener {
	...
	private final static String[] starts = {"Top", "Left", "Bottom", "Right"};
	...
	/**
	 *  Main processing method for the Slicer object
	 *
	...
	/**
	 *  Gets the slice attribute of the Slicer object
	 *
	 *@param  imp     Description of the Parameter
	...
	/**
	 *  Gets the irregularProfile attribute of the Slicer object
	 *
	 *@param  roi  Description of the Parameter
	 *@param  ip   Description of the Parameter
	...
	/**
	 *  Gets the line attribute of the Slicer object
	 *
	 *@param  ip    Description of the Parameter
	 *@param  x1    Description of the Parameter
	 *@param  y1    Description of the Parameter
	...
	/**
	 *  Gets the orthoLine attribute of the Slicer object
	 *
	 *@param  ip    Description of the Parameter
	 *@param  x1    Description of the Parameter
	 *@param  y1    Description of the Parameter
	...
	/**
	 *  Gets the size attribute of the Slicer object
	 *
	 *@param  inSpacing   Description of the Parameter
	 *@param  outSpacing  Description of the Parameter
	...
	/**
	 *  Gets the outputStackSize attribute of the Slicer object
	 *
	 *@param  inSpacing   Description of the Parameter
	 *@param  outSpacing  Description of the Parameter
	 *@param  count       Description of the Parameter
	 *@return             The outputStackSize value
	 */
	...
	/**
	 *  Gets the availableMemory attribute of the Slicer object
	 *
	 *@return    The availableMemory value
	 */
