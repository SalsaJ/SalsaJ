...
public class Selection implements PlugIn, Measurements {
	...
	/**
	 *  Main processing method for the Selection object
	 *
	...
	/**
	 *  Gets the length attribute of the Selection object
	 *
	...
	/**
	 *  Gets the curvature attribute of the Selection object
	 *
	 *@param  x  Description of the Parameter
	...
	/**
	 *  Adds a feature to the ToRoiManager attribute of the Selection object
	 *
	 *@param  imp  The feature to be added to the ToRoiManager attribute
	 */
