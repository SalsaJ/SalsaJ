...
//	private final static int PLOT_FILLED = 4;
	...
	/**
	 *  Sets the surfacePlotImage attribute of the SurfacePlot object
	 *
	 *@param  imp  The new surfacePlotImage value
	 */
	...
	/**
	 *  Sets the surfacePlotImage_orig attribute of the SurfacePlot object
	 *
	 *@param  imp  The new surfacePlotImage_orig value
	 */
...
//						if (maskPixels[my *mWidth + mx ] == 0)
//							c = pixelsOrigColor[j] = (255 << 24) |  (pixelsTmp[i] & 0xFFFFFF);
//							//c = pixelsOrigColor[j] = (254 << 24) |  (pixelsTmp[i] & 0xFFFFFF);
//						else
	...
	/**
	 *  Sets the surfacePlotTextureImage attribute of the SurfacePlot object
	 *
	 *@param  imp  The new surfacePlotTextureImage value
	 */
...
//		imp2.updateAndDraw();
	...
	/**
	 *  Sets the surfacePLotSetLight attribute of the SurfacePlot object
	 *
	 *@param  light  The new surfacePLotSetLight value
	 */
	...
	/**
	 *  Sets the surfaceGridSize attribute of the SurfacePlot object
	 *
	 *@param  width   The new surfaceGridSize value
	 *@param  height  The new surfaceGridSize value
	 */
	...
	/**
	 *  Sets the surfacePlotMode attribute of the SurfacePlot object
	 *
	 *@param  surfacePlotMode  The new surfacePlotMode value
	 */
	...
	/**
	 *  Sets the buffers attribute of the SurfacePlot object
	 *
	 *@param  bufferPixels   The new buffers value
	 *@param  zbufferPixels  The new buffers value
	 *@param  bufferWidth    The new buffers value
	 *@param  bufferHeight   The new buffers value
	 */
	...
	/**
	 *  Sets the transform attribute of the SurfacePlot object
	 *
	...
	/**
	 *  Sets the surfacePlotCenter attribute of the SurfacePlot object
	 *
	 *@param  xCenter  The new surfacePlotCenter value
	 *@param  yCenter  The new surfacePlotCenter value
	 *@param  zCenter  The new surfacePlotCenter value
	 */
	...
	/**
	 *  Sets the surfacePlotLut attribute of the SurfacePlot object
	 *
	 *@param  lutNr  The new surfacePlotLut value
	 */
	...
	/**
	 *  Sets the minMax attribute of the SurfacePlot object
	 *
	 *@param  min  The new minMax value
	 *@param  max  The new minMax value
	 */
	...
	/**
	 *  Sets the inverse attribute of the SurfacePlot object
	 *
