...
/**
 *  This plugin reads BMP files. If 'arg' is empty, it displays a file open
 *  dialog and opens and displays the selected file. If 'arg' is a path, it
 *  opens the specified file and the calling routine can display it using
...
public class BMP_Reader extends ImagePlus implements PlugIn {
	...
	/**
	 *  Main processing method for the BMP_Reader object
	 *
...
class BMPDecoder {
	...
	/**
	 *  Gets the fileHeader attribute of the BMPDecoder object
	 *
	 *@exception  IOException  Description of the Exception
	...
	/**
	 *  Gets the bitmapHeader attribute of the BMPDecoder object
	 *
	 *@exception  IOException  Description of the Exception
	 */
	...
	/**
	 *  Gets the palette attribute of the BMPDecoder object
	 *
	 *@exception  IOException  Description of the Exception
	 */
	 ...
	 *  Description of the Method
	 *
	 *@param  rawData        Description of the Parameter
	 *@param  rawOffset      Description of the Parameter
	 *@param  bpp            Description of the Parameter
	 *@param  byteData       Description of the Parameter
	 *@param  byteOffset     Description of the Parameter
	 ...
	 *@param  rawData    Description of the Parameter
	 *@param  rawOffset  Description of the Parameter
	 *@param  intData    Description of the Parameter
	 *@param  intOffset  Description of the Parameter
	 *@param  w          Description of the Parameter
	 */
	...
	/**
	 *  Gets the pixelData attribute of the BMPDecoder object
	 *
	 *@exception  IOException  Description of the Exception
	 *@exception  Exception    Description of the Exception
	 */
