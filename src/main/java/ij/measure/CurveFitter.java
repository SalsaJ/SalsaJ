 ...
 *  340-362. 2001/02/14: Midified to handle a gamma variate curve. Uses altered
 *  Simplex method based on method in "Numerical Recipes in C". This method
 *  tends to converge closer in less iterations. Has the option to restart the
 *  simplex at the initial best solution in case it is "stuck" in a local
 *  minimum (by default, restarted once). Also includes settings dialog option
 *  for user control over simplex parameters and functions to evaluate the
...
public class CurveFitter {
	 ...
	 */
	public final static int STRAIGHT_LINE = 0, POLY2 = 1, POLY3 = 2, POLY4 = 3,
			EXPONENTIAL = 4, POWER = 5, LOG = 6, RODBARD = 7, GAMMA_VARIATE = 8, LOG2 = 9, RODBARD2 = 10, EXP_WITH_OFFSET = 11;

	/**
	 *  Description of the Field
	 */
	public final static int IterFactor = 500;

	/**
	 *  Description of the Field
	 */
	public final static String[] fitList = {"Straight Line", "2nd Degree Polynomial",
	 ...
	 *  Description of the Field
	 */
	public final static String[] fList = {"y = a+bx", "y = a+bx+cx^2",
	...
	private final static double alpha = -1.0;// reflection coefficient
	private final static double beta = 0.5;// contraction coefficient
	private final static double gamma = 2.0;// expansion coefficient
	private final static double root2 = 1.414214;// square root of 2
	 ...
	 *
	 *@param  xData  Description of the Parameter
	 *@param  yData  Description of the Parameter
	 */
	...
	/**
	 *  Perform curve fitting with the simplex method doFit(fitType) just does the
	 *  fit doFit(fitType, true) pops up a dialog allowing control over simplex
	 *  parameters alpha is reflection coefficient (-1) beta is contraction
	 *  coefficient (0.5) gamma is expansion coefficient (2)
	 *
	 ...
	 *
	 *@param  fitType       Description of the Parameter
	 *@param  showSettings  Description of the Parameter
	 */
	 ...
	 *
	 *@param  fit  Description of the Parameter
     ...
     */
	/**
	 *  Gets the sumResidualsSqr attribute of the CurveFitter object
	 *
	...
	/**
	 *  Returns R^2, where 1.0 is best. <pre>
	 *r^2 = 1 - SSE/SSD
	 ...
	 *
	 *@param  x  The new maxIterations value
	 */
	 ...
	 *
	 *@param  x  The new restarts value
	 */
	 ...
	 *
	 *@param  params  The new initialParameters value
	 */
