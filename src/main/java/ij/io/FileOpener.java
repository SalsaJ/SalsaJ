...
/**
 *  Opens or reverts an image specified by a FileInfo object. Images can be
 *  loaded from either a file (directory+fileName) or a URL (url+fileName). Here
 *  is an example: <pre>
...
public class FileOpener {
	...
	/**
	 *  Constructor for the FileOpener object
	 *
	...
	/**
	 *  Opens the image. Displays it if 'show' is true. Returns an ImagePlus object
	 *  if successful.
	 *
	...
	/**
	 *  Sets the stackDisplayRange attribute of the FileOpener object
	 *
	 *@param  imp  The new stackDisplayRange value
	 */
	...
	/**
	 *  Sets the calibration attribute of the FileOpener object
	 *
	 *@param  imp  The new calibration value
	 */
	...
	long size = fi.width * fi.height * fi.getBytesPerPixel();
		...
		if (fi.height == 1) {
			size = 0;
		}// allows plugins to read info of unknown length at end of file
	...
	/**
	 *  Gets the number attribute of the FileOpener object
	 *
	...
	/**
	 *  Gets the double attribute of the FileOpener object
	 *
	 *@param  props  Description of the Parameter
	 *@param  key    Description of the Parameter
	...
	/**
	 *  Gets the boolean attribute of the FileOpener object
	 *
	 *@param  props  Description of the Parameter
	 *@param  key    Description of the Parameter
