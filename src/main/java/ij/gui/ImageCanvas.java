...
public class ImageCanvas extends Canvas implements MouseListener, MouseMotionListener, Cloneable {
	...
	private final static int LIST_OFFSET = 100000;
	...
	/*
	  ...
	  */
	/**
	 *  Gets the image attribute of the ImageCanvas object
	 *
	...
	/**
	 *  Sets the drawingSize attribute of the ImageCanvas object
	 *
	 *@param  width   The new drawingSize value
	 *@param  height  The new drawingSize value
	 */
	...
	/**
	 *  ImagePlus.updateAndDraw calls this method to get paint to update the image
	 *  from the ImageProcessor.
	 */
	...
	/**
	 *  Gets the sliceNumber attribute of the ImageCanvas object
	 *
	 ...
	 *
	 *@param  sx  The new cursor value
	 *@param  sy  The new cursor value
	 *@param  ox  The new cursor value
	 *@param  oy  The new cursor value
	 */
	 ...
	 *
	 *@param  ox  Description of the Parameter
	 *@return     Description of the Return Value
	 */
	 ...
	 *
	 *@param  oy  Description of the Parameter
	 *@return     Description of the Return Value
	 */
	...
	/**
	 *  Gets the magnification attribute of the ImageCanvas object
	 *
	...
	/**
	 *  Sets the magnification attribute of the ImageCanvas object
	 *
	 *@param  magnification  The new magnification value
	 */
	...
	/**
	 *  Sets the magnification2 attribute of the ImageCanvas object
	 *
	 *@param  magnification  The new magnification2 value
	 */
	...
	/**
	 *  Gets the srcRect attribute of the ImageCanvas object
	 *
	 *@return    The srcRect value
	 */
	...
	/**
	 *  Sets the srcRect attribute of the ImageCanvas object
	 *
	 *@param  srcRect  The new srcRect value
	 */
	...
	/**
	 *  Sets the maxBounds attribute of the ImageCanvas object
	 */
	void setMaxBounds() {
		if (maxBoundsReset) {
	...
	private final static double[] zoomLevels = {
	...
	/**
	 *  Gets the lowerZoomLevel attribute of the ImageCanvas class
	 *
	 *@param  currentMag  Description of the Parameter
	 *@return             The lowerZoomLevel value
	 */
	...
	/**
	 *  Gets the higherZoomLevel attribute of the ImageCanvas class
	 *
	 *@param  currentMag  Description of the Parameter
	 *@return             The higherZoomLevel value
	 */
	 ...
	 *  the source rectangle (srcRect) smaller and center it at (x,y).
	 *
	 ...
	 *  Description of the Method
	 *
	 *@param  newMag  Description of the Parameter
	 *@param  x       Description of the Parameter
	 *@param  y       Description of the Parameter
	 */
	 ...
	 *@param  newHeight  Description of the Parameter
	 *@return            Description of the Return Value
	 */
	...
	/**
	 *  Zooms out by making the source rectangle (srcRect) larger and centering it
	 *  on (x,y). If we can't make it larger, then make the window smaller.
	 *
	 *@param  x  Description of the Parameter
	 *@param  y  Description of the Parameter
	 */
	...
	/**
	 *  Gets the color attribute of the ImageCanvas object
	 *
	 *@param  index  Description of the Parameter
	...
	/**
	 *  Sets the drawingColor attribute of the ImageCanvas object
	 *
	 *@param  ox             The new drawingColor value
	 *@param  oy             The new drawingColor value
	 *@param  setBackground  The new drawingColor value
	 */
	...
	/**
	 *  Sets the foregroundColor attribute of the ImageCanvas object
	 *
	...
	/**
	 *  Sets the backgroundColor attribute of the ImageCanvas object
	 *
	...
	void handleRoiMouseDown(MouseEvent e) {
		...
		if (roi != null) {
			...
			//	return;
			//}
			if ((tool == Toolbar.POLYGON || tool == Toolbar.POLYLINE) && !(IJ.shiftKeyDown() || IJ.altKeyDown())) {
				imp.killRoi();
				return;
			}
		}
	...
	/**
	 *  Sets the roiModState attribute of the ImageCanvas object
	 *
	 *@param  e       The new roiModState value
	 *@param  roi     The new roiModState value
	 *@param  handle  The new roiModState value
	 */
	...
	/**
	 *  Sets the showAllROIs attribute of the ImageCanvas object
	 *
	 *@param  showAllROIs  The new showAllROIs value
	 */
	...
	/**
	 *  Gets the showAllROIs attribute of the ImageCanvas object
	 *
	 *@return    The showAllROIs value
	 */
	 ...
	 *
	 *@param  c  The new showAllColor value
	 */
	...
	/**
	 *  Sets the displayList attribute of the ImageCanvas object
	 *
	 *@param  list  The new displayList value
	 */
	 ...
	 *  Sets the displayList attribute of the ImageCanvas object
	 *
	 *@param  shape   The new displayList value
	 *@param  color   The new displayList value
	 *@param  stroke  The new displayList value
	 */
	 ...
	 *
	 *@param  status  The new showCursorStatus value
	 */
	...
	public void mouseReleased(MouseEvent e) {
		...
		if (roi != null) {
			...
			if ((r.width == 0 || r.height == 0)
				...
				//if ((r.width == 0 || r.height == 0)
				//		 && !(type == Roi.POLYGON || type == Roi.POLYLINE || type == Roi.LINE)
				//		 && roi.getState() == roi.CONSTRUCTING) {
				imp.killRoi();
			}
			else {
