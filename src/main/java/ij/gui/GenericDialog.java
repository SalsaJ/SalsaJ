 ...
 *  GenericDialog with one string field and two numeric fields: <pre>
 ...
 *   }
 * }
 * </pre> To work with macros, the first word of each component label must be
 *  unique. If this is not the case, add underscores, which will be converted to
 *  spaces when the dialog is displayed. For example, change the checkbox labels
...
public class GenericDialog extends Dialog implements ActionListener,
     ...
     */
    public final static int MAX_SLIDERS = 25;
    /**
     *  Description of the Field
     */
     ...
     *  hereon.
     *
     *@param  label         The feature to be added to the Checkbox attribute
     *@param  defaultValue  The feature to be added to the Checkbox attribute
     *@param  isPreview     The feature to be added to the Checkbox attribute
     */
     ...
     *  the additional method previewRunning for optical feedback while preview is
     *  prepared. PlugInFilters can have their "run" method automatically called
     *  for preview under the following conditions: - the PlugInFilter must pass a
     ...
     *  parameters in the dialogItemChanged method. - it must have DIALOG and
     *  PREVIEW set in its flags. A previewCheckbox is always off when the filter
     *  is started and does not get recorded by the Macro Recorder.
     *
     ...
     *  addPreviewCheckbox method with standard "Preview" label Note that a
     *  GenericDialog can have only one PreviewCheckbox
     *
     *@param  pfr    The feature to be added to the PreviewCheckbox attribute
     *@param  label  The feature to be added to the PreviewCheckbox attribute
     */
     ...
     *
     *@param  text  The feature to be added to the Message attribute
     */
     ...
     *@param  rows     the number of rows
     *@param  columns  The feature to be added to the TextAreas attribute
     */
    ...
    /**
     *  Adds a feature to the Slider attribute of the GenericDialog object
     *
     *@param  label         The feature to be added to the Slider attribute
     *@param  minValue      The feature to be added to the Slider attribute
     *@param  maxValue      The feature to be added to the Slider attribute
     *@param  defaultValue  The feature to be added to the Slider attribute
     */
     ...
     *
     *@param  panel       The feature to be added to the Panel attribute
     *@param  contraints  The feature to be added to the Panel attribute
     *@param  insets      The feature to be added to the Panel attribute
     */
     ...
     *  component added to the dialog. <pre>
     *Default insets:
     ...
     *</pre>
     *
     *@param  top     The new insets value
     *@param  left    The new insets value
     *@param  bottom  The new insets value
     */
    ...
    /**
     *  Gets the insets attribute of the GenericDialog object
     *
     ...
     *  if the dialog has been invoked by a macro; it should read all input fields
     *  of the dialog. For other listeners, the OK button will not cause a call to
    ...
    /**
     *  Gets the value attribute of the GenericDialog object
     *
    ...
    /**
     *  Gets the match attribute of the GenericDialog object
     *
     ...
     *
     *@return    The nextChoiceIndex value
     */
     ...
     *
     *@return    The numericFields value
     */
    ...
    /**
     *  Returns a reference to the Label or MultiLineLabel created by addMessage(),
     *  or null if addMessage() was not called.
     *
     ...
     *
     *@return    The previewCheckbox value
     */
    ...
    /**
     *  optical feedback whether preview is running by switching from "Preview" to
     *  "wait..."
     *
     *@param  isRunning  Description of the Parameter
     */
    public void previewRunning(boolean isRunning) {
        if (previewCheckbox != null) {
            ...
            if (IJ.isMacOSX()) {
                repaint();
            }//workaround OSX 10.4 refresh bug
        }
    }
    ...
    private void notifyListeners(AWTEvent e) {
        ...
        if (workaroundOSXbug) {
            repaint();
        }// OSX 10.4 bug delays update of enabled until the next input
    }
