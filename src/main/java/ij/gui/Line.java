...
public class Line extends Roi {
	 ...
	 *
	 *@param  ox1  Description of the Parameter
	 *@param  oy1  Description of the Parameter
	 *@param  ox2  Description of the Parameter
	 *@param  oy2  Description of the Parameter
	 */
	public Line(int ox1, int oy1, int ox2, int oy2) {
	 ...
	 *  selection. 'sx' and 'sy' are screen coordinates that specify the start of
	 *  the line. The user will determine the end of the line interactively using
	 *  rubber banding.
	 *
	...
	/**
	 *  Gets the polygon attribute of the Line object
	 *
	...
	/**
	 *  Gets the width attribute of the Line class
	 *
	...
	/**
	 *  Sets the width attribute of the Line class
	 *
