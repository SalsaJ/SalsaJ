...
public class Functions implements MacroConstants, Measurements {
	...
	void doFunction(int type) {
		System.out.println("Function.doFunction type=" + type);
		switch (type) {
						case RUN:
							doRun();
							break;
	...
	/**
	 *  Gets the functionValue attribute of the Functions object
	 *
	 * @param  type  Description of the Parameter
	 * @return       The functionValue value
	 */
	final double getFunctionValue(int type) {
		...
		switch (type) {
						...
						case LAST_INDEX_OF:
							...
							break;
						case CHAR_CODE_AT:
							value = getFirstString().charAt((int) getLastArg());
							break;
						case GET_BOOLEAN:
							value = getBoolean();
							break;
	...
	/**
	 *  Gets the stringFunction attribute of the Functions object
	 *
	 * @param  type  Description of the Parameter
	...
	/**
	 *  Gets the arrayFunction attribute of the Functions object
	 *
	 * @param  type  Description of the Parameter
	 * @return       The arrayFunction value
	 */
	...
	/**
	 *  Gets the string attribute of the Functions object
	 *
	...
	/**
	 *  Gets the arg attribute of the Functions object
	 *
	...
	/**
	 *  Gets the firstArg attribute of the Functions object
	 *
	 * @return    The firstArg value
	 */
	...
	/**
	 *  Gets the nextArg attribute of the Functions object
	 *
	 * @return    The nextArg value
	 */
	...
	/**
	 *  Gets the lastArg attribute of the Functions object
	 *
	 * @return    The lastArg value
	 */
	...
	/**
	 *  Gets the stringArg attribute of the Functions object
	 *
	 * @return    The stringArg value
	 */
	String getStringArg() {
		interp.getLeftParen();
	...
	/**
	 *  Gets the firstString attribute of the Functions object
	 *
	 * @return    The firstString value
	 */
	...
	/**
	 *  Gets the nextString attribute of the Functions object
	 *
	 * @return    The nextString value
	 */
	...
	/**
	 *  Gets the lastString attribute of the Functions object
	 *
	 * @return    The lastString value
	 */
	...
	/**
	 *  Gets the booleanArg attribute of the Functions object
	 *
	 * @return    The booleanArg value
	 */
	...
	/**
	 *  Gets the firstVariable attribute of the Functions object
	 *
	 * @return    The firstVariable value
	 */
	...
	/**
	 *  Gets the nextVariable attribute of the Functions object
	 *
	 * @return    The nextVariable value
	 */
	...
	/**
	 *  Gets the lastVariable attribute of the Functions object
	 *
	 * @return    The lastVariable value
	 */
	...
	/**
	 *  Gets the variable attribute of the Functions object
	 *
	...
	/**
	 *  Gets the firstArrayVariable attribute of the Functions object
	 *
	 * @return    The firstArrayVariable value
	 */
	...
	/**
	 *  Gets the nextArrayVariable attribute of the Functions object
	 *
	 * @return    The nextArrayVariable value
	 */
	...
	/**
	 *  Gets the lastArrayVariable attribute of the Functions object
	 *
	 * @return    The lastArrayVariable value
	 */
	...
	/**
	 *  Gets the arrayVariable attribute of the Functions object
	 *
	 * @return    The arrayVariable value
	 */
	...
	/**
	 *  Gets the firstArray attribute of the Functions object
	 *
	 * @return    The firstArray value
	 */
	...
	/**
	 *  Gets the nextArray attribute of the Functions object
	 *
	 * @return    The nextArray value
	 */
	...
	/**
	 *  Gets the lastArray attribute of the Functions object
	 *
	 * @return    The lastArray value
	 */
	...
	/**
	 *  Gets the numericArray attribute of the Functions object
	 *
	 * @return    The numericArray value
	 */
	...
	/**
	 *  Gets the stringArray attribute of the Functions object
	 *
	...
	/**
	 *  Gets the array attribute of the Functions object
	 *
	...
	/**
	 *  Gets the color attribute of the Functions object
	 *
	...
	void doRun() {
		...
		System.out.println("Function.doRun arg1=" + arg1);
		interp.getToken();
	...
	/**
	 *  Sets the foregroundColor attribute of the Functions object
	 */
	...
	/**
	 *  Sets the backgroundColor attribute of the Functions object
	 */
	...
	/**
	 *  Sets the color attribute of the Functions object
	 */
	void setColor() {
		colorSet = true;
		interp.getLeftParen();
	...
	/**
	 *  Gets the image attribute of the Functions object
	 *
	...
	/**
	 *  Gets the processor attribute of the Functions object
	 *
	...
	/**
	 *  Gets the type attribute of the Functions object
	 *
	...
	/**
	 *  Sets the pixel attribute of the Functions object
	 */
	void setPixel() {
		interp.getLeftParen();
	...
	/**
	 *  Gets the pixel attribute of the Functions object
	 *
	...
	/**
	 *  Sets the zCoordinate attribute of the Functions object
	 */
	void setZCoordinate() {
		int z = (int) getArg();
		ImagePlus imp = getImage();
	 ...
	 *  Sets the foregroundColor attribute of the Functions object
	 *
	 * @param  ip  The new foregroundColor value
	 */
	...
	/**
	 *  Sets the font attribute of the Functions object
	 *
	 * @param  ip  The new font value
	 */
	...
	/**
	 *  Sets the justification attribute of the Functions object
	 */
	...
	/**
	 *  Gets the result attribute of the Functions object
	 *
	...
	/**
	 *  Gets the resultLabel attribute of the Functions object
	 *
	 * @return    The resultLabel value
	 */
	...
	/**
	 *  Sets the result attribute of the Functions object
	 */
	void setResult() {
		interp.getLeftParen();
...
//EU_HOU Bundle
	...
	/**
	 *  Gets the number attribute of the Functions object
	 *
	...
	/**
	 *  Gets the boolean attribute of the Functions object
	 *
	...
	/**
	 *  Gets the boolean2 attribute of the Functions object
	 *
	 * @return    The boolean2 value
	 */
	double getBoolean2() {
		String prompt = getFirstString();
	...
	/**
	 *  Gets the stringDialog attribute of the Functions object
	 *
	 * @return    The stringDialog value
	 */
	...
	/**
	 *  Gets the stackSize attribute of the Functions object
	 *
	...
	/**
	 *  Gets the imageCount attribute of the Functions object
	 *
	...
	/**
	 *  Gets the resultsCount attribute of the Functions object
	 *
	 * @return    The resultsCount value
	 */
	...
	/**
	 *  Gets the coordinates attribute of the Functions object
	 */
	void getCoordinates() {
	...
	/**
	 *  Gets the profile attribute of the Functions object
	 *
	...
	/**
	 *  Gets the fileList attribute of the Functions object
	 *
	...
	/**
	 *  Gets the info attribute of the Functions object
	 *
	...
	/**
	 *  Gets the windowContents attribute of the Functions object
	 *
	 * @return    The windowContents value
	 */
	...
	/**
	 *  Gets the imageInfo attribute of the Functions object
	 *
	...
	/**
	 *  Gets the directory attribute of the Functions object
	 *
	...
	/**
	 *  Gets the selectionType attribute of the Functions object
	 *
	 ...
	 *  Description of the Method
	 *
	 * @param  withCancel  Description of the Parameter
	 */
	...
	/**
	 *  Gets the cursorLoc attribute of the Functions object
	 */
	void getCursorLoc() {
	...
	/**
	 *  Gets the line attribute of the Functions object
	 */
	void getLine() {
	...
	/**
	 *  Gets the voxelSize attribute of the Functions object
	 */
	void getVoxelSize() {
	...
	/**
	 *  Gets the histogram attribute of the Functions object
	 */
	void getHistogram() {
		interp.getLeftParen();
	...
	/**
	 *  Gets the lut attribute of the Functions object
	 */
	void getLut() {
	...
	/**
	 *  Sets the lut attribute of the Functions object
	 */
	void setLut() {
	...
	/**
	 *  Gets the threshold attribute of the Functions object
	 */
	void getThreshold() {
	...
	/**
	 *  Gets the pixelSize attribute of the Functions object
	 */
	void getPixelSize() {
	...
	void doPlot() {
		...
		/*} else if (name.equals("update")) {
			...
			plotWindow.setLimits(getFirstArg(), getNextArg(), getNextArg(), getLastArg());
			return;
		 /*} else if (name.equals("addText") || name.equals("drawLabel")) {
			...
			plotWindow.setLineWidth((int) getArg());
			return;
	...
	void newPlot() {
		...
		interp.getRightParen();
		plotWindow = new PlotWindow(title, xLabel, yLabel, x, y);
	}
	...
	void updatePlot() {
		if (plotWindow != null) {
			...
			if (true) {
				...
				PlotWindow plotWindow = plotWindow.draw();
	...
	/**
	 *  Adds a feature to the PlotText attribute of the Functions object
	 */
	void addPlotText() {
		...
		plotWindow.setJustification(justification);
		plotWindow.addLabel(x, y, str);
	}


	/**
	 *  Sets the plotColor attribute of the Functions object
	 */
	void setPlotColor() {
		interp.getLeftParen();
		plotWindow.setColor(getColor());
		interp.getRightParen();
	}


	/**
	 *  Adds a feature to the ToPlot attribute of the Functions object
	 *
	 * @param  what  The feature to be added to the ToPlot attribute
	 */
	void addToPlot(int what) {
		...
		interp.getRightParen();
		if (what == -1) {
			/*plotWindow.addErrorBars(float(y));
		} else { */
			plotWindow.addPoints(x, y, what);
		}
	}


	/**
	 *  Gets the bounds attribute of the Functions object
	 */
	void getBounds() {
		Variable x = getFirstVariable();
		Variable y = getNextVariable();
	...
	/**
	 *  Gets the active attribute of the Functions object
	 *
	...
	/**
	 *  Gets the open attribute of the Functions object
	 *
	...
	/**
	 *  Sets the keyDown attribute of the Functions object
	 */
	void setKeyDown() {
	...
	/**
	 *  Gets the minAndMax attribute of the Functions object
	 */
	void getMinAndMax() {
	...
	/**
	 *  Sets the batchMode attribute of the Functions object
	 */
	void setBatchMode() {
	 ...
	 *  Description of the Method
	 *
	 * @param  imp2  Description of the Parameter
	 */
	...
	/**
	 *  Sets the location attribute of the Functions object
	 */
	void setLocation() {
	...
	/**
	 *  Sets the slice attribute of the Functions object
	 */
	void setSlice() {
		int n = (int) getArg();
		ImagePlus imp = getImage();
	...
	/**
	 *  Gets the zoom attribute of the Functions object
	 *
	...
	/**
	 *  Sets the autoThreshold attribute of the Functions object
	 */
	 ...
	 *  Description of the Method
	 *
	 * @param  tw  Description of the Parameter
	 * @param  s   Description of the Parameter
	 */
	...
	/**
	 *  Gets the keyDown attribute of the Functions object
	 *
	 * @return    The keyDown value
	 */
	double isKeyDown() {
		double value = 0.0;
	 ...
	 *  Description of the Method
	 *
	 * @param  eval  Description of the Parameter
	 * @return       Description of the Return Value
	 */
	...
	/**
	 *  Sets the threshold attribute of the Functions object
	 */
	void setThreshold() {
	...
	/**
	 *  Gets the screenDimension attribute of the Functions object
	 *
	 * @param  type  Description of the Parameter
	 * @return       The screenDimension value
	 */
	...
	/**
	 *  Gets the statistics attribute of the Functions object
	 *
	 * @param  calibrated  Description of the Parameter
	 */
	...
	/**
	 *  Sets the voxelSize attribute of the Functions object
	 */
	void setVoxelSize() {
	...
	/**
	 *  Gets the locationAndSize attribute of the Functions object
	 */
	...
	/**
	 *  Gets the dateAndTime attribute of the Functions object
	 */
	void getDateAndTime() {
	...
	/**
	 *  Sets the metadata attribute of the Functions object
	 */
	void setMetadata() {
	...
	/**
	 *  Gets the metadata attribute of the Functions object
	 *
	...
	/**
	 *  Gets the imageArg attribute of the Functions object
	 *
	 * @return    The imageArg value
	 */
	...
	/**
	 *  Sets the rGBWeights attribute of the Functions object
	 */
	void setRGBWeights() {
	...
	String doFile() {
		...
		String name = interp.tokenString;
                System.out.println("Macro command "+name);
		if (name.equals("Open")) {
                        System.out.println("Macro command "+name);
			return openFile();
	...
	/**
	 *  Gets the valid attribute of the Functions object
	 *
	...
	/**
	 *  Sets the selectionName attribute of the Functions object
	 */
	...
	/**
	 *  Gets the fontList attribute of the Functions object
	 *
	 * @return    The fontList value
	 */
	...
	/**
	 *  Sets the option attribute of the Functions object
	 */
	void setOption() {
	...
	/**
	 *  Sets the selectionLocation attribute of the Functions object
	 */
	...
	/**
	 *  Gets the list attribute of the Functions object
	 *
	...
	/**
	 *  Gets the clipboardContents attribute of the Functions object
	 *
	 * @return    The clipboardContents value
	 */
	...
	/**
	 *  Gets the buffer attribute of the Functions object
	 *
	...
	/**
	 *  Gets the dimensions attribute of the Functions object
	 */
	void getDimensions() {
		Variable width = getFirstVariable();
		Variable height = getNextVariable();
	...
	/**
	 *  Gets the value attribute of the Functions object
	 *
