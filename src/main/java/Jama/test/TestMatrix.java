...
/**
 * TestMatrix tests the functionality of the ij3d.Jama Matrix class and associated decompositions.
 *<P>
 *Run the test from the command line using
 *<BLOCKQUOTE><PRE><CODE>
 *java ij3d.Jama.test.TestMatrix
 *</CODE></PRE></BLOCKQUOTE>
...
public class TestMatrix {
	...
	public static void main(String argv[]) {
		...
		try {
			...
			PrintWriter FILE = new PrintWriter(new FileOutputStream("ij3d.JamaTestMatrix.out"));
			A.print(FILE, fmt, 10);
			FILE.close();
			R = Matrix.read(new BufferedReader(new FileReader("ij3d.JamaTestMatrix.out")));
